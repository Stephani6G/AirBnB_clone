...
"""module that defines unittests for models/review.py
all test cases for reviews of places
Unittest classes:
...
class TestReview_instantiation(unittest.TestCase):
    """for testing instantiation of the Review class"""
...
class TestReview_save(unittest.TestCase):
    """for testing save method of the Review class"""
...
class TestReview_to_dict(unittest.TestCase):
    """for testing to_dict method of the Review class"""
